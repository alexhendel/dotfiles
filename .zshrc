...
# Keybindings
bindkey -e
bindkey '^p' history-search-backward    # Search history with up arrow keys
bindkey '^n' history-search-forward     # Search history with down arrow keys
